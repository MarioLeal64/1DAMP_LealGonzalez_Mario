...
Un \*\*Programa informático\*\* es un conjunto de procesos informáticos realizados por el ordenador para completar una tarea o resolver un problema específico.
...
El \*\*código fuente\*\* es lo que escribe el propio programador, el \*\*código objeto\*\* es el código fuente en el proceso de traducción del compilador, haciendo que el ordenador sea capaz de entenderlo, y el \*\*código ejecutable\*\* es, como su nombre indica, el código ya traducido y que la máquina puede comprender.
